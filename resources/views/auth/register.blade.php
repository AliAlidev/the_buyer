...
<head>
    ...
    <meta charset="utf-8" />
    <title>Register | The Buyer - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body data-topbar="colored">
    ...
    <div class="wrapper-page">
            ...
            <div class="card-body">
                ...
                <div class="auth-logo">
                    <h3 class="text-center">
                        <a href="index.html" class="logo d-block my-4">
                            <img src="assets/images/logo-dark.png" class="logo-dark mx-auto" height="30"
                                alt="logo-dark">
                            <img src="assets/images/logo-light.png" class="logo-light mx-auto" height="30"
                                alt="logo-light">
                        </a>
                    </h3>
                </div>
                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal " action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="userpassword">Password Confirmation</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col-12">
                                <p class="font-size-14 text-muted mb-0">By registering you agree to the Agroxa <a
        ...
        <div class="text-center">
            <p class="text-muted">Already have an account ? <a href="pages-login.html" class="text-white"> Login </a>
            </p>
            <p class="text-muted">©
                <script>
