                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('shape/list_shapes.list_shapes_title') }}</h4>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="row mb-5">
                                <div class="col-md-3">
                                    <label for="merchant_type">{{ __('shape/list_shapes.merchant_type') }}</label>
                                    <select name="merchant_type" id="merchant_type" class="form-select">
                                        <option value=""></option>
                                        <option value="1">{{ __('shape/list_shapes.merchant_type_pharmacy') }}
                                        </option>
                                        <option value="2">{{ __('shape/list_shapes.merchant_type_market') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <table class="table table-bordered data-table" style="width: 100%">
                                <thead style="background-color: #1b82ec; color: white">
                                    <tr>
                                        <th style="text-align: center;">{{ __('shape/list_shapes.table_header_id') }}
                                        </th>
                                        <th style="text-align: center">
                                            {{ __('shape/list_shapes.list_shapes_header_ar_name') }}
                                        </th>
                                        <th style="text-align: center">
                                            {{ __('shape/list_shapes.list_shapes_header_en_name') }}
                                        </th>
                                        <th style="text-align: center">
                                            {{ __('shape/list_shapes.merchant_type') }}
                                        </th>
                                        <th style="text-align: center">
                                            {{ __('shape/list_shapes.list_shapes_header_en_action') }}
                                        </th>
                                    </tr>
                                </thead>
