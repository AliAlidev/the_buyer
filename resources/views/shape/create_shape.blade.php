                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('shape/create_shape.create_shape_title') }}</h4>
                        </div>
                        <div class="card-body">
                            <!-- Demo purpose only -->
                            <div style="min-height: 300px;">
                                ...
                                <form id="main_form" action="" style="margin: 5%">
                                    <div class="row d-flex justify-content-center mt-4">
                                        <div class="col-md-2">
                                            <label for="type">{{ __('shape/create_shape.merchant_type') }}</label>
                                            <select name="type" id="type" class="form-select">
                                                <option value="1">
                                                    {{ __('shape/create_shape.merchant_type_pharmacy') }}
                                                </option>
                                                <option value="2">
                                                    {{ __('shape/create_shape.merchant_type_market') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <label for="">{{ __('shape/create_shape.shape_name_ar') }}</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-10">
                                    ...
                                    <div class="row mt-4">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <label for="">{{ __('shape/create_shape.shape_name_en') }}</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-10">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <button class="btn btn-primary"
                                                type="submit">{{ __('shape/create_shape.create_btn') }}</button>
                                        </div>
                                    </div>
