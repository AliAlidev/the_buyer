                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <ul class="nav nav-pills nav-justified recent-activity-tab mb-4"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="activity1-tab"
                                                        data-bs-toggle="pill" href="#activity1" role="tab"
                                                        aria-controls="activity1" aria-selected="true">21 Sep</a>
                                                </li>
                                                <li class="nav-item">
